 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://server.demo.com/", wsdlLocation = "http://192.168.0.107:8080/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://server.demo.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.107:8080/helloService?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://server.demo.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.demo.com/", "HelloServicePort"), HelloService.class, features);
    }
